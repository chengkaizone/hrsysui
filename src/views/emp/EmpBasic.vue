	...
	<div>
		<div>
			<div style="display: flex; justify-content: space-between;">
				<div>
					<el-input placeholder="请输入员工名, 回车搜索..." 
				...
				<div>
					...
					<el-button type="primary" @click="showAddEmpView" icon="el-icon-plus">添加用户</el-button>
				</div>
			</div>
				...
				style="border: 1px solid #409eff; border-radius 5px; box-sizing: border-box; padding: 5px; margin: 10px 0px;">
					<el-row>
						<el-col :span="5">
							...
							<el-select v-model="searchValue.politicId" placeholder="政治面貌" size="mini" style="width: 130px;">
								<el-option
									v-for="item in politicsstatus" :key="item.id" :label="item.name" :value="item.id">
									</el-option>
							</el-select>
						</el-col>
						<el-col :span="4">
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="5">
							...
							v-model="popVisible2"
							>
								<el-tree default-expand-all :data="allDeps" :props="defaultProps" @node-click="searchViewHandleNodeClick">
								</el-tree>
								<div slot="reference" style="width: 130px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box;margin-left: 3px"
									@click="showDepView2"
									>
									{{inputDepName}}
								</div>
			...
			<el-table :data="emps"
				...
				<el-table-column
					...
					<template slot-scope="scope">
						...
						<el-button @click="showAdvanceProfile(scope.row)" style="padding: 3px;" size="mini" type="primary">高级资料</el-button>
					...
					<el-row>
						...
						<el-col :span="6">
							<el-form-item label="合同终止日期:" prop="endContract">
								<el-date-picker
									v-model="emp.endContract" size="mini"
									type="date"
									value-format="yyyy-MM-dd"
									style="width: 150px;"
									placeholder="合同终止日期"
...
<script>
	...
	export default {
		...
		data() {
			return {
				...
				emp: {
					...
					workId: "34532",
					contractTerm: 3,
					conversionTime: "2020-03-01",
					notworkDate: null,
					beginContract: "2020-01-01",
		...
		methods: {
			...
			showAdvanceProfile(data) {
				Message.success({message: "显示高级资料"})
			},
			deleteEmp(data) {
